...
try:
    ...
    if st.checkbox("Before going for prediction please ensure you have required number of features."):
        ...
        if st.button("Predict"):
            ...
            #st.write("Based on High chance of Outage :")
            #col11,col12 = st.columns(2)
            #with col11:
            #    st.metric(label="Customer at risk", value=n[n['Prediction'] == "High Chance of Outage"]['Customer At Risk'].sum(), delta="500")
            #with col12:
            #    st.metric(label="Asset at risk", value=len(n[n['Prediction'] == "High Chance of Outage"]['Fee_Sw_Refe_ID'].unique()), delta="10")"""
